...
def getLocalDateTime(timezone):
	tehran_tz = pytz.timezone('Asia/Tehran')
	aware_datetime_tehran = tehran_tz.localize(timezone)
	current_datetime_tehran = timezone.now().astimezone(tehran_tz)
	return current_datetime_tehran
